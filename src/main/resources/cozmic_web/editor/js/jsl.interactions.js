    ...
    function validate() {
        ...
        try {
            ...
            if (result) {
                ...
                if (reformat) {
                    $('#editor-text').val(JSON.stringify(JSON.parse(jsonVal), null, "    "));
                }
            ...
            **/
            try {
                if (reformat) {
                    jsonVal = jsl.format.formatJson($('#editor-text').val());
                    $('#editor-text').val(jsonVal);
                    result = jsl.parser.parse($('#editor-text').val());
                }
            } catch(e) {
                parseException = e;
            }
            ...
            if (lineMatches && typeof lineMatches === "object" && lineMatches.length > 1) {
                ...
                $('#editor-text').focus().caret(lineStart, lineEnd);
            }
